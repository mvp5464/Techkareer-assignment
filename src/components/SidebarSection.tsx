  ...
  return (
    <div className=" border-l-2 py-6">
      <div className=" flex justify-center items-center gap-3 mx-5">
        <button className=" flex items-center justify-center gap-2 font-[500] border border-[#DC4A2D] text-[#DC4A2D] bg-[#FEF4F2] rounded-lg px-3 py-2 w-full ">
          <DeleteIcon className="w-4 h-4" />
          <span className="text-sm">Delete job</span>
        </button>
        <button className=" flex items-center justify-center gap-2 font-[500] border border-[#FED3CA] text-white bg-[#DC4A2D] rounded-lg px-3 py-2 w-full ">
